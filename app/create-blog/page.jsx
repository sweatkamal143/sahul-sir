    ...
    <section className="container max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          >
            <option value="Songbirds">Frontend Developer</option>
            <option value="Waterfowl">Backend Developer</option>
            <option value="Parrots">Devops</option>
            <option value="Seabirds">MERN Developer</option>
            <option value="Gamebirds">Data Analyst</option>
          </select>
        </div>
